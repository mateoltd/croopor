...
func (s *Server) registerRoutes() {
	...
	s.mux.HandleFunc("GET /api/v1/versions/{id}/info", s.handleVersionInfo)
	s.mux.HandleFunc("DELETE /api/v1/versions/{id}", s.handleDeleteVersion)
	s.mux.HandleFunc("POST /api/v1/versions/{id}/open-folder", s.handleOpenVersionFolder)
