...
5. Upload these asset keys:
   - `croopor` for the large image.
   - `croopor_idle` for launcher idle.
   - `croopor_launching` for Minecraft startup.
   - `croopor_minecraft` for active Minecraft.
   - `croopor_multi` for multiple active sessions.
