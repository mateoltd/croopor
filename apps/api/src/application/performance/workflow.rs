use super::PerformancePlanSummaryViewModel;
use crate::guardian::{
...
pub struct PerformanceInstanceOperationResponse {
    pub operation: Option<PerformanceOperationStatus>,
}
...
pub async fn performance_health(
    ...
    let view_model = super::performance_plan_summary_view_model(
        mode,
        Some(&plan),
        health,
...
pub async fn performance_install(
    ...
    execute_performance_operation(&state, &operation).await
}

pub async fn performance_operation_status(
    state: &AppState,
    id: &str,
) -> Result<PerformanceOperationStatus, (StatusCode, Json<serde_json::Value>)> {
    state
...
fn disabled_health_response(
    ...
    PerformanceHealthResponse {
        ...
        view_model: super::performance_plan_summary_view_model(
            mode,
            None,
            BundleHealth::Disabled,
            None,
