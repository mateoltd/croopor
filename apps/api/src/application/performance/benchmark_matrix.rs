...
#[derive(Debug, Clone, Serialize, PartialEq, Eq)]
pub(crate) struct BenchmarkModeDescriptor {
    pub id: &'static str,
...
#[derive(Debug, Clone, Serialize, PartialEq, Eq)]
pub(crate) struct BenchmarkRunTypeDescriptor {
    pub id: &'static str,
    pub description: &'static str,
}

#[derive(Debug, Clone, Serialize, PartialEq, Eq)]
pub(crate) struct BenchmarkProfileDescriptor {
    pub id: &'static str,
...
#[derive(Debug, Clone, Serialize, PartialEq, Eq)]
pub(crate) struct BenchmarkTargetDescriptor {
    pub id: &'static str,
...
#[derive(Debug, Clone, Serialize, PartialEq, Eq)]
pub(crate) struct BenchmarkMatrixLimits {
    pub max_payload_bytes: usize,
    pub custom_post_values_allowed: bool,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) struct BenchmarkSuiteRunSpec {
    pub profile: &'static str,
    pub run_type: &'static str,
...
pub(crate) fn benchmark_suite_plan(mode: &str) -> Option<Vec<BenchmarkSuiteRunSpec>> {
    match mode {
...
pub(crate) fn benchmark_suite_run_id(
    mode: &str,
    run_index: usize,
...
pub(crate) fn benchmark_suite_manifest_run_inputs(
    mode: &str,
