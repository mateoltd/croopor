...
Calm, capable, protective. The UI should feel like a sharp desktop tool: dense enough for repeated use, clear enough for non-technical users, and restrained enough that alerts and Guardian interventions carry real weight.
...
- Guardian first: safety, recovery, and guidance should be visible where decisions happen, especially launch and runtime settings.
...
Use accessible names for controls, keyboard-reachable settings, visible focus states, calm copy, and reduced-motion-friendly transitions. Do not rely on color alone for health, warning, or disabled states.
